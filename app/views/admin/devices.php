...
<?php $pageTitle = 'Device Management'; ?>
<?php require __DIR__ . '/../layouts/header.php'; ?>

<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="fw-bold mb-0"><i class="bi bi-cpu me-2"></i>Device Management</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="<?= BASE_URL ?>/admin/devices/create">
                <input type="hidden" name="csrf_token" value="<?= Auth::csrfToken() ?>">
                <div class="modal-header"><h5 class="modal-title">Add Device</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="<?= BASE_URL ?>/admin/devices/update">
                ...
                <div class="modal-body">
                    <div class="mb-3"><label class="form-label">Name</label><input type="text" name="name" id="editDeviceName" class="form-control" required></div>
                    <div class="mb-3"><label class="form-label">Location</label><input type="text" name="location" id="editDeviceLocation" class="form-control"></div>
                    <div class="row">
                    ...
                    <div class="mt-3">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="editDeviceActive">Active</label>
                        </div>
                    </div>
                </div>
